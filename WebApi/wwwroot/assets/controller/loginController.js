(function () {
    ...
    front.controller.LoginController = function LoginController($location, loginAPI, userService) {
    ...
    // コントローラー定義
    angular.module('App').controller('loginController', ['$location', 'loginAPI', 'userService', front.controller.LoginController]);
}());
